...
using ClassFinalProduct.Serialization;
namespace WinForm
{
    public partial class FormMain : Form
    {
        ...
        {
            Product pr = new Product("iPhone 11", 23400, 5234, "Крутой телефон");
            _company.AddProduct(pr);
            User u = new User("Денис", "Володин", 35);
            ClassFinalProduct.Сonsumer c = new ClassFinalProduct.Сonsumer(899695543, u, "Москва");
            _company.AddConsumer(c);
            _company.AddDeal(new Deal(DateTime.Now, pr, 25, c, false));
        }
        ...
        {
            saveFileDialog.Filter = "JSON-файлы|*.json|Все файлы|*.*";
            if (saveFileDialog.ShowDialog() == DialogResult.OK)
                CompanySerializable.Save(saveFileDialog.FileName,SerializeType.JSON);
        }
        ...
        private void xmlExportToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            if (saveFileDialog.ShowDialog() == DialogResult.OK)
                CompanySerializable.Save(saveFileDialog.FileName, SerializeType.XML);
        }

        private void binExportToolStripMenuItem_Click(object sender, EventArgs e)
        {
            saveFileDialog.Filter = "Двоичные файлы|*.bin|Все файлы|*.*";
            if (saveFileDialog.ShowDialog() == DialogResult.OK)
                CompanySerializable.Save(saveFileDialog.FileName, SerializeType.BIN);
        }
        ...
        private void jsonToolStripMenuItem_Click(object sender, EventArgs e)
        {
            saveFileDialog.Filter = "JSON-файлы|*.json|Все файлы|*.*";
            if (saveFileDialog.ShowDialog() == DialogResult.OK)
                CompanySerializable.Load(saveFileDialog.FileName, SerializeType.JSON);
        }
        ...
        private void xmlToolStripMenuItem_Click(object sender, EventArgs e)
        {
            saveFileDialog.Filter = "XML-файлы|*.xml|Все файлы|*.*";
            if (saveFileDialog.ShowDialog() == DialogResult.OK)
                CompanySerializable.Load(saveFileDialog.FileName, SerializeType.XML);
        }
        ...
        private void binToolStripMenuItem_Click(object sender, EventArgs e)
        {
            saveFileDialog.Filter = "Двоичные файлы|*.bin|Все файлы|*.*";
            if (saveFileDialog.ShowDialog() == DialogResult.OK)
                CompanySerializable.Load(saveFileDialog.FileName, SerializeType.BIN);
        }
    }
}
